...
public class MyDecode extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        System.out.println("MyEncode => in: " + JSON.toJSONString(in));
        // 1. 读取消息类型
        short messageType = in.readShort();
        System.out.println("MyEncode => messageType: " + messageType);
        ...
        System.out.println("MyEncode => serializerType: " + serializerType);
        // 根据类型得到相应的序列化器
